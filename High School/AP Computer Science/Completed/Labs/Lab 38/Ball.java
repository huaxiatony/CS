...
public class Ball implements Dragable
{
	...
	public Ball(double x, double y, DrawingCanvas canva)
	{
		outer = new FilledOval(x, y, 50, 50, canva); outer.setColor(Color.red);
		inner1 = new FilledOval(x + 5, y + 5, 40, 40, canva); inner1.setColor(Color.white);
		inner2 = new FilledOval(x + 10, y + 10, 30, 30, canva); inner2.setColor(Color.red);
		inner3 = new FilledOval(x + 15, y + 15, 20, 20, canva); inner3.setColor(Color.white);
		inner4 = new FilledOval(x + 20, y + 20, 10, 10, canva); inner4.setColor(Color.red);
	}
	public Ball(Location l, DrawingCanvas c) 
	{
