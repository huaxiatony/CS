...
{
	private FilledOval outer; private FilledOval inner1; private FilledOval inner2; private FilledOval inner3; 
	...
	{
		outer.moveTo(dx, dy); inner1.moveTo(dx, dy); inner2.moveTo(dx, dy); inner3.moveTo(dx, dy); inner4.moveTo(dx, dy);
	}
