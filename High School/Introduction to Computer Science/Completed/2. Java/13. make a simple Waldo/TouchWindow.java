...
public class TouchWindow extends WindowController
{
	...
	public void begin()
	{
		...
		pein = new FilledOval(Math.random()*300, Math.random()*300,50,50,canvas);
		pein.setColor(Color.red);
	}
	public void onMousePress(Location point)
	{
		pein.removeFromCanvas();
		pein = new FilledOval(Math.random()*1000, Math.random()*1000,50,50,canvas);
		pein.setColor(Color.red);
	}
